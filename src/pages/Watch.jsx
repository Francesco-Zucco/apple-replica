...
import { useFetchWatches } from "../components/useFetchProducts";
                  ...
                  <div className="place-items-end  flex items-center gap-2">
                    <div className="w-[40px] h-[40px]">
                      ...
                      <img
                        ...
                        src="./images/icons/store-chat-specialist-icon.png"
                        alt=""
                      />
                    </div>
                    <div className="">
